...
export const registerEventTemplate = (username, eventTitle, eventLocation, eventDate, eventLink) => {
    return `
    <!DOCTYPE html>
    <html lang="en">
    <head>
    ...
    <body>
        <div class="container">
            <h2>🎉 You're Registered for <strong>${eventTitle}</strong>!</h2>
            <p>Hi <strong>${username}</strong>,</p>
            <p>Thanks for registering! Here are the event details:</p>
